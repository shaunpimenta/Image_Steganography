...
import os
# img = cv2.imread(r'C:\Users\Shaun\Desktop\Academics\SEM 6\CSS\CSS Project\camera.jpg')
...
# ax.scatter(r, g, b)
# plt.show()
def encrpyt(msg,key,name):
    original_img = cv2.imread(r'C:\Users\Shaun\Desktop\Academics\SEM 6\CSS\CSS Project\static\uploads'+f'\{name}')
    ...
    clustered_img.save(r'C:\Users\Shaun\Desktop\Academics\SEM 6\CSS\CSS Project\static'+'\clustered_img.png')
    ...
    cluster1_img.save(r'C:\Users\Shaun\Desktop\Academics\SEM 6\CSS\CSS Project\static'+'\cluster1_img.png')

    plt.imshow(cluster2)
    cluster2_img = Image.fromarray(cluster2)
    cluster2_img.save(r'C:\Users\Shaun\Desktop\Academics\SEM 6\CSS\CSS Project\static'+'\cluster2_img.png')

    plt.imshow(cluster3)
    cluster3_img = Image.fromarray(cluster3)
    cluster3_img.save(r'C:\Users\Shaun\Desktop\Academics\SEM 6\CSS\CSS Project\static'+'\cluster3_img.png')
    ...
    image1 = cv2.imread(r'C:\Users\Shaun\Desktop\Academics\SEM 6\CSS\CSS Project\static' + '\cluster1_img.png')
    image_encoded1 = hideData(image1, chunk1)
    cv2.imwrite(r'C:\Users\Shaun\Desktop\Academics\SEM 6\CSS\CSS Project\static' + '\cluster1_img_encoded.png',
                image_encoded1)

    image2 = cv2.imread(r'C:\Users\Shaun\Desktop\Academics\SEM 6\CSS\CSS Project\static' + '\cluster2_img.png')
    image_encoded2 = hideData(image2, chunk2)
    cv2.imwrite(r'C:\Users\Shaun\Desktop\Academics\SEM 6\CSS\CSS Project\static' + '\cluster2_img_encoded.png',
                image_encoded2)

    image3 = cv2.imread(r'C:\Users\Shaun\Desktop\Academics\SEM 6\CSS\CSS Project\static' + '\cluster3_img.png')
    image_encoded3 = hideData(image3, chunk3)
    cv2.imwrite(r'C:\Users\Shaun\Desktop\Academics\SEM 6\CSS\CSS Project\static' + '\cluster3_img_encoded.png',
                image_encoded3)
...
def decryptt(key):
        # cipher = AES.new(key, AES.MODE_ECB)
        image_dec1 = cv2.imread(r'C:\Users\Shaun\Desktop\Academics\SEM 6\CSS\CSS Project\static'+'\cluster1_img_encoded.png')
        decoded_chunk1 = showData(image_dec1)
        print("decoded chunk1:", decoded_chunk1)

        image_dec2 = cv2.imread(r'C:\Users\Shaun\Desktop\Academics\SEM 6\CSS\CSS Project\static'+'\cluster2_img_encoded.png')
        decoded_chunk2 = showData(image_dec2)
        print("decoded chunk2:", decoded_chunk2)

        image_dec3 = cv2.imread(r'C:\Users\Shaun\Desktop\Academics\SEM 6\CSS\CSS Project\static'+'\cluster3_img_encoded.png')
        ...
        print(decoded_encrypted_msg.decode())
        return decoded_encrypted_msg.decode()

app=Flask(__name__)
app.config['UPLOAD_FOLDER']=r'C:\Users\Shaun\Desktop\Academics\SEM 6\CSS\CSS Project\static\uploads'
@app.route('/')
def home():
...
def encrypt():
    if request.method=='POST':
        plain=request.form['pt']
        key=request.form['key']
        f=request.files['file']
        f.save(os.path.join(app.config['UPLOAD_FOLDER'], f.filename))
        print(plain,key)
        encrpyt(plain,key,f.filename)
        return render_template('encryptres.html',result="Sucess")
...
def decrypt():
    if request.method=='POST':
        ...
        f.save(os.path.join(app.config['UPLOAD_FOLDER'], "cluster1_img_encoded.png"))
        f2.save(os.path.join(app.config['UPLOAD_FOLDER'], "cluster2_img_encoded.png"))
        f3.save(os.path.join(app.config['UPLOAD_FOLDER'], "cluster3_img_encoded.png"))

        return render_template('decryptres.html',data=decryptt('1'))
